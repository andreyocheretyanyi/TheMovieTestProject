...
class SearchPersonFragment : BaseFragment<SearchViewModel>() {
    ...
    override fun onCreateView(
        ...
        return DataBindingUtil.inflate<FragmentSearchPeopleBinding>(
            inflater,
            ...
            .apply {
                ...
                viewModel = this@SearchPersonFragment.viewModel
            }.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.personSearchedName.observe(
            this.viewLifecycleOwner,
            viewModel.enteredPersonNameObserver
        )
    }
